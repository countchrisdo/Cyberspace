/// @description  BktGlitch_config(lineShift, lineSpeed, lineResolution, lineDrift, lineVerticalShift, jumbleness, jumbleSpeed, jumbleResolution, jumbleShift, noiseLevel, channelShift, channelDispersion, shakiness, intensity, rngSeed)
...
/// @param  intensity
/// @param  rngSeed
function BktGlitch_config(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11, argument12, argument13, argument14) {
	/*
